    ...
    <div className="max-w-xl mx-auto p-6 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md">
      {!resultado ? (
        ...
        <>
          ...
          {resultado === "녹색" && <p>우울감을 매우 잘 관리하고 있으며 정서적으로 안정된 상태입니다. 다른 사람들을 돕는 데 큰 도움이 될 수 있습니다.</p>}
          {resultado === "황색" && <p>해결이 필요한 정서적 어려움의 분명한 신호가 있습니다. 의지와 도움을 통해 충분히 극복할 수 있습니다.</p>}
          {resultado === "적색" && <p>이 주제와 관련된 정서적 문제가 심각하여 전문적인 도움이 필요합니다. 가능한 빨리 의사나 심리 전문가를 찾으십시오.</p>}
          <button
